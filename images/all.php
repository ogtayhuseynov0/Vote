        ...
        echo '<div class="col s12 m4 l4 inSec name">
            <div class="card small myshad">
                <div class="card-image z-depth-1">
                    <img src="images/'.$row['prof_image']. '" onerror="this.src=\'images/ins2.jpg\'">
                </div>
                ...
                <div class="card-action ">
                    <div class="myColor2"> ' . $avg . ' <i class="fa fa-star " aria-hidden="true"></i> <a href="profile.php?id=' . $row['id'] . '"
